...
const FROM = process.env.EMAIL_FROM || 'FleetInfoSync - Modern infotainment system integration for Japanese automotive market <noreply@example.com>';
const APP_NAME = 'FleetInfoSync - Modern infotainment system integration for Japanese automotive market';
