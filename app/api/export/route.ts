  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="FleetInfoSync - Modern infotainment system integration for Japanese automotive market-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
