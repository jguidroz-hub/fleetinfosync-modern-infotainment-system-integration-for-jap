  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">FleetInfoSync - Modern infotainment system integration for Japanese automotive market</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Bridges outdated car infotainment systems with smartphone functionality for Japanese drivers who currently ignore built-in systems. Provides seamless navigation, entertainment, and connectivity.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust FleetInfoSync - Modern infotainment system integration for Japanese automotive market.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} FleetInfoSync - Modern infotainment system integration for Japanese automotive market. All rights reserved.</p>
