...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-8">Here's your FleetInfoSync - Modern infotainment system integration for Japanese automotive market overview.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
          <a href="/dashboard/vehicles" className="block p-4 border rounded-lg hover:bg-blue-50 transition">
            ...
            <p className="text-sm text-gray-500">Manage connected vehicles and systems</p>
          </a>
          <a href="/dashboard/device-connections" className="block p-4 border rounded-lg hover:bg-blue-50 transition">
            <h3 className="font-medium">Device Integrations</h3>
            <p className="text-sm text-gray-500">Smartphone and vehicle connection management</p>
          </a>
